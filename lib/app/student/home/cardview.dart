...
import 'package:unicollab/app/student/assignment/StudentAssignmentPage.dart';
import 'package:unicollab/app/student/material/StudentMaterialPage.dart';
import 'package:unicollab/app/student/notice/noticepage.dart';
    ...
    return Container(
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            CupertinoPageRoute(builder: (_) => NoticePage(document, code)),
          );
        },
        child: Card(
          elevation: 0.0,
